document.addEventListener('DOMContentLoaded', async function() {
    try {
        ...
        const getResponse = await fetch('http://web-api-lb-465634550.ap-south-1.elb.amazonaws.com/people');
...
document.getElementById('userForm').addEventListener('submit', async function(event) {
    ...
    try {
      const response = await fetch('http://web-api-lb-465634550.ap-south-1.elb.amazonaws.com/people', {
        method: 'POST',
        headers: {
